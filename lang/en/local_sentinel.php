...
$string['overview_action_cache'] = '{$a} cache store(s) not ready';
$string['overview_action_cert'] = 'TLS certificate expires in {$a} day(s)';
$string['overview_action_cert_expired'] = 'The TLS certificate has expired';
$string['overview_action_core_update'] = 'Moodle core update available: {$a}';
$string['overview_action_critical'] = '{$a} critical system check(s)';
$string['overview_action_cron'] = 'Cron has not run for {$a}';
$string['overview_action_debug'] = 'Developer debugging is enabled';
$string['overview_action_disk'] = 'Disk space low: {$a} free on moodledata';
$string['overview_action_errors'] = '{$a} check(s) reporting errors';
$string['overview_action_failed_tasks'] = '{$a} scheduled task(s) failing';
$string['overview_action_go'] = 'Review';
$string['overview_action_heading'] = 'Action needed';
$string['overview_action_locked'] = '{$a} account(s) currently locked out';
$string['overview_action_none'] = 'Nothing needs your attention.';
$string['overview_action_none_detail'] = 'All checks clear as of this page load.';
$string['overview_action_os_reboot'] = 'A system reboot is required to apply OS updates';
$string['overview_action_os_updates'] = '{$a} OS security update(s) pending';
$string['overview_action_overdue_tasks'] = '{$a} scheduled task(s) overdue';
$string['overview_action_plugin_updates'] = '{$a} plugin update(s) available';
$string['overview_action_tokens_expiring'] = '{$a} web service token(s) expire within 30 days';
$string['overview_action_tokens_noip'] = '{$a} web service token(s) without an IP restriction';
...
$string['overview_collapsed_checks'] = 'Show the {$a} passing / not-applicable check(s)';
$string['overview_collapsed_plugins'] = 'Show the {$a} up-to-date plugin(s)';
...
$string['overview_dashboard_note'] = 'Sentinel checks all of this when you load the page. Connect this site to a Sentinel dashboard to have it watched continuously — with alerting, uptime history, and scheduled reports. <a href="{$a->connecturl}">Connect to a dashboard</a> · <a href="{$a->dismissurl}">Dismiss</a>';
...
$string['registration_code_button'] = 'Connect with code';
$string['registration_code_desc'] = 'If your dashboard operator gave you a provisioning code, paste it here — it fills in the connection settings and registers this site in one step.';
$string['registration_code_invalid'] = 'That provisioning code is not valid. Check that you copied the whole code, or configure the connection manually below.';
$string['registration_code_label'] = 'Provisioning code';
